...
export default function handleCheckList(e, todo) {
    ...
    appendChild(
        listItems.subList.el,
        listItems.subCheckbox.el,
        listItems.subTitle.el,
        listItems.subDeleteButton.el
    );
    appendChild(listItems.subLists.el, listItems.subList.el);
    event.parentElement.parentElement.insertBefore(
        listItems.subLists.el,
        event.parentElement
    );
